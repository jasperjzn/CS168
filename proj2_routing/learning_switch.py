...
class LearningSwitch(api.Entity):
    ...
    def handle_link_down(self, port):
        ...
        """
        for (key, val) in self.learningDict:
            if(val == port):
                del self.learningDict[key]
    ...
    def handle_rx(self, packet, in_port):
        ...
        # simple hub.
        self.learningDict[packet.src] = in_port
        ...
        if packet.dst in self.learningDict:
           self.send(packet, self.learningDict[packet.dst], flood = False) 
        else:
